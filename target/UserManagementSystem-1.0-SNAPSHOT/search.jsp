...
<%@page import="com.mycompany.controller.ConnectionClass"%>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <!-- Topbar Search -->
                        <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="/User-Management-System/Search">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered"  width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th class="column1">user_id</th>
                                                    <th class="column2">first_name</th>
                                                    <th class="column3">last_name</th>
                                                    <th class="column4">username</th>
                                                    <th class="column5">email</th>
                                                    <th class="column6">gender</th>
                                                    <th class="column7">birthdate</th>                                                    
                                                    <th class="column8">is_admin</th>
                                                    <th class="column9">user_created_date</th>
                                                    <th class="column10">user_blocked_status</th>
                                                    
                                                </tr>
                                            </thead>
                                          <tbody>
                                <c:forEach items="${searchUser}" var = "searched">
                                    <tr>
                                        <td class="column1">${searched.user_id}</td>
                                        <td class="column2">${searched.first_name}</td>
                                        <td class="column3">${searched.last_name}</td>
                                        <td class="column4">${searched.username}</td>
                                        <td class="column5">${searched.email}</td>
                                        <td class="column6">${searched.gender}</td>
                                        <td class="column7">${searched.user_birthdate}</td>
                                        <td class="column8">${searched.user_is_admin}</td>
                                        <td class="column9">${searched.user_created_date}</td>
                                        <td class="column10">${searched.user_blocked_status}</td>
