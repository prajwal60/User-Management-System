                ...
                <div id="content">
                    ...
                    <main>
                        ...
                        <div class="container-fluid">
                            <h1 class="mt-4">Block User From Here</h1>
                                            ...
                                            <%
                                                if (session != null) {
                                                    try {
                                                        ...
                                                        String query = "select * from userdb where user_blocked_status=?";
                                                        PreparedStatement ps = con.prepareStatement(query);
                                                        ...
                                                        while (rs.next()) {
                                                            ...
                                                            out.print("</td>");
                                                            out.print("<td>");
                                                            out.print("<button value="+rs.getString(1)+" name=\"user_id\" type=\"submit\"> Block User</button> ");
                                                            History h=new History(rs.getInt(1),  LocalDateTime.now().toString(), "User "+rs.getString(2)+"Blocked");
