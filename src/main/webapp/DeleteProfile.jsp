                ...
                <div id="content">
                    ...
                    <main>
                        <div class="container-fluid">
                            ...
                            <form action="/User-Management-System/DeleteAdmin" method="POST">
                                                ...
                                                if (session != null) {
                                                    try {
                                                        ...
                                                        while (rs.next()) {
                                                            ...
                                                            out.print("<td>");
                                                            out.print("<button type=\"submit\"> Delete My Account</button> ");
                                                            History h=new History(rs.getInt(1),  LocalDateTime.now().toString(), "User Deleted");
