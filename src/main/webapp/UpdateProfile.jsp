                ...
                <div id="content">
                    ...
                    <main>
                        <div class="container-fluid">
                            ...
                            <form action="/User-Management-System/UpdatingAdmin" method="POST">
                                                ...
                                                if (session != null) {
                                                    try {
                                                        ...
                                                        while (rs.next()) {
                                                            ...
                                                            out.print("</td>");
                                                            out.print("<td>");
                                                            out.print("Please Update Your Form Below");
                                                            ...
                                                            out.print("</td>");
                                                            out.print("<td>");
                                                            out.print("<input type=\"text\" name=\"firstname\" placeholder="+rs.getString(2)+" required>");
                                                            out.print("</td>");
                                                            out.print("</tr>");
                                                            out.print("<tr>");
                                                            out.print("<tr>");
                                                            ...
                                                            out.print("</td>");
                                                            out.print("<td>");
                                                            out.print("<input type=\"text\" name=\"lastname\" placeholder="+rs.getString(3)+" required>");
                                                            out.print("</td>");
                                                            out.print("</tr>");
                                                            out.print("<tr>");
                                                            out.print("<tr>");
                                                            ...
                                                            out.print("</td>");
                                                            out.print("<td>");
                                                            out.print("<input type=\"text\" name=\"Username\" placeholder="+rs.getString(4)+" required>");
                                                            out.print("</td>");
                                                            out.print("</tr>");
                                                            out.print("<tr>");
                                                            out.print("<tr>");
                                                            ...
                                                            out.print("</td>");
                                                            out.print("<td>");
                                                            out.print("<input type=\"text\" name=\"Email\" type=\"email\" placeholder="+rs.getString(5)+" required>");
                                                            out.print("</td>");
                                                            out.print("</tr>");
                                                            out.print("<tr>");
                                                            out.print("<tr>");
                                                            ...
                                                            out.print("</td>");
                                                            out.print("<td>");
                                                            out.print("<input type=\"text\" name=\"Gender\" placeholder="+rs.getString(6)+" required>");
                                                            out.print("</td>");
                                                            out.print("</tr>");
                                                            out.print("<tr>");
                                                            out.print("<tr>");
                                                            ...
                                                            out.print("</td>");
                                                            out.print("<td>");
                                                            out.print("<input type=\"date\" name=\"Birthdate\" type=\"date\" >");
                                                            out.print("</td>");
                                                            out.print("</tr>");
                                                            out.print("<tr>");
                                                            out.print("<th>Click to update Profile ==></th>");
                                                            out.print("<td>");
                                                            out.print("");
                                                            out.print("</td>");
                                                            out.print("<td>");
                                                            out.print("<button type=\"submit\"> Update</button> ");
                                                            History h=new History(rs.getInt(1),  LocalDateTime.now().toString(), "User Profile Updated");
