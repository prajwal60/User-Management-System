        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <!-- End of Topbar -->
                    <main>
                        <form action="RemoveSender" method="POST">
                        
                        <div class="container-fluid">
                            <h1 class="mt-4">You can Remove Admin From Here</h1>
                                            ...
                                            <%
                                                if (session != null) {
                                                    try {
                                                        ...
                                                        String query = "select * from userdb where user_is_admin=?";
                                                        PreparedStatement ps = con.prepareStatement(query);
                                                        ps.setString(1,"true");
                                                        ResultSet rs = ps.executeQuery();
                                                        while (rs.next()) {
...
//                                                            out.print("<input name=\"user_id\"  type=\"hidden\" value="+rs.getString(1)+" required>");
                                                            out.print("<button value="+rs.getString(1)+" name=\"user_id\" type=\"submit\"> Remove Admin </button> ");
                                                            History h=new History(rs.getInt(1),  LocalDateTime.now().toString(), "User Removed From Admin");
